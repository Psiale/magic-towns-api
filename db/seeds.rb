...
State.create!(name: "Estado de México")
...
MagicTown.create!(name: "Real de Asientos",
...
MagicTown.create!(name: "Calvillo",
...
MagicTown.create!(name: "San José de Gracia",
...
MagicTown.create!(name: "Todos ​Sant​os",
...
MagicTown.create!(name: "Palizada",
...
MagicTown.create!(name: "San Cristóbal de las Casas",
...
MagicTown.create!(name: "Comitán de Domínguez​​​​​",
...
MagicTown.create!(name: "Chiapa de Corzo",
...
MagicTown.create!(name: "Palenque",
...
MagicTown.create!(name: "Batopilas",
...
MagicTown.create!(name: "Casas Grandes ",
...
MagicTown.create!(name: "Parras de la Fuente",
...
MagicTown.create!(name: "Cuatro Ciénegas",
...
MagicTown.create!(name: "Guerrero",
...
MagicTown.create!(name: "Mapimí",
                        ...
                        state_id: 9)
MagicTown.create!(name: "Dolores Hidalgo",
...
MagicTown.create!(name: "Mineral del Pozo",
...
MagicTown.create!(name: "Jalpa",
                        ...
                        state_id: 10)
MagicTown.create!(name: "Salvatierra",
...
MagicTown.create!(name: "Huasca de Ocampo",
...
MagicTown.create!(name: "Real del Monte",
...
MagicTown.create!(name: "Mineral el chico",
...
MagicTown.create!(name: "Huichapan",
...
MagicTown.create!(name: "Tecozautla",
...
MagicTown.create!(name: "Mazamitla",
...
MagicTown.create!(name: "San Sebastian del Oeste",
...
MagicTown.create!(name: "Lagos de Moreno",
...
MagicTown.create!(name: "Talpa de Allende",
...
MagicTown.create!(name: "Tepotzotlán",
...
MagicTown.create!(name: "Valle de Bravo",
...
MagicTown.create!(name: "​Malinalco",
...
MagicTown.create!(name: "Aculco",
                        ...
                        festivities: "19 de febrero: Se festeja la fundación del municipio y se realiza una ceremonia alusiva al día.​Marzo-Abril representación escénica de la Semana Mayor, iniciando el Jueves Santo, Las celebraciones ​son en honor al Señor ​Nenthé.​30 de septiembre: Se festeja al Santo Patrono San Jerónimo a quien celebran con gran algarabía y danzas de santiagueros y concheros, hay ferias regionales, en las que se exponen distintos productos alimenticios, elaborados por los propios habitantes",
...
MagicTown.create!(name: "​Teotihuacán y San Martín de las Pirámides​",
...
MagicTown.create!(name: "​​Ixtapan de la Sal",
...
MagicTown.create!(name: "Villa del Carbón​​​​​​​​",
...
MagicTown.create!(name: "Pátzcuaro",
...
MagicTown.create!(name: "​​Tlalpujahua",
...
MagicTown.create!(name: "​Santa Clara del Cobre",
                        ...
                        festivities: "Feria Nacional del Cobre: se celebrá del 2 al 17 de agosto, la cual coincide con la festividad religios.a​Fiesta de Santa Clara de Asís​: se celebrá los días 11 y 12 de Agosto.​Fiesta de Nuestra Señora del Sagrario​: se celebrá el 15 de Agosto",
...
MagicTown.create!(name: "Angangueo",
...
MagicTown.create!(name: "​Tacámbaro",
...
MagicTown.create!(name: "Jiquilpan",
...
MagicTown.create!(name: "Tzintzuntzan​​​​​​",
...
MagicTown.create!(name: "Tepoztlan",
...
MagicTown.create!(name: "Tlayacapan",
                        characteristics: '​Se incorporó en el programa Pueblos Mágicos en el año 2011.En el pueblo hay siete bandas de viento tradicionales, pero la Banda de Tlayacapanes la que ha preservado el espíritu del pueblo.​Una parte de la ​magia de Tlayacapan reside en su pasado prehispánico, tiempos en que fue habitado por olmecas, quienes a su vez, fueron dominados por el pueblo xochimilca.​Este lugar “sobre la punta de la tierra”, fue paso comercial obligado para los pueblos del sur que se abastecían de diversos productos, entre ellos la cera​.',
                        attractions: "Ex Convento de San Juan Bautista.​Museo de Tlayacapan.Capillas de Tlayacapan.Centro Cultural La Cerería.Tour por el corredor arqueológico​",
...
MagicTown.create!(name: "Sayulita",
...
MagicTown.create!(name: "Santiago",
                        ...
                        festivities: "Muestra gastronómica: el primer sábado de junio se realiza una muestra gastronómica en la que los restaurantes de la zona se reúnen para ofrecer platillos regionales e internacionales así como postres y bebidas típicas​.San Pedro y San Pablo: el 29 de junio se celebra a estos santos en la plaza con misas y procesiones.​Señor Santiago: el 25 de julio se celebra al patrono del pueblo​ Festival de la Manzana: en la segunda quincena de agosto se reúnen los productores de la zona y exhiben sus frutos y comida derivada de la manzana",
                        location: "La ubicación de este municipio se encuentra en las inmediaciones​ de la Sierra Madre Oriental​.​",
                        state_id: 18)

MagicTown.create!(name: "Linares",
...
MagicTown.create!(name: "​Capulálpam de Méndez",
...
MagicTown.create!(name: "​Huautla de Jiménez​",
                        characteristics: 'Se incorporó al ​​programa de Pueblos Mágicos en el año 2015.La palabra Huautla, proviene del vocablo náhuatl y significa "Lugar de Águilas".El clima es considerado generalmente como templado húmedo con lluvias la mayor parte del año, con excepción de una corta temporada entre los meses de Marzo a Mayo, que es la época calurosa y sin lluvias​',
                        attractions: 'Cosmovisión y legado de la "Sacerdotisa de los Hongos"  María Sabina.Grutas de San Agustín.Cascada Velo de Novia.Cerro de la Adoración.Río Teoti.Templo Casa de CulturaTorre de reloj',
                        festivities: "Festejo de la Virgen de la Natividad el 7 y 8 de septiembre.Festejo de la Virgen de Santa María Juquila el 7 y 8 de diciembre.El Día de Muertos.El 22 de Julio de 1894 es el natalicio de María Sabina del 16 de Julio.Los representativos Sones Mazatecos.Festividad de las 3 caídas el 3er viernes de Cuaresma",
                        location: "​Huautla de Jiménez se localiza al noroeste de la Capital del estado y se sitúa a 254 Km.El Municipio de Huautla de Jiménez colinda al norte con Santa María Chilchotla y San José Tenango​​",
                        state_id: 19)

MagicTown.create!(name: "​Mazunte",
...
MagicTown.create!(name: "​San Pablo​ ​​Villa de Mitla​​",
...
MagicTown.create!(name: "​​San Pedro y San Pablo",
...
MagicTown.create!(name: "​​Cuetzalan",
...
MagicTown.create!(name: "​​Zacatlán de las Manzanas​",
...
MagicTown.create!(name: "Pahuatlán",
                        characteristics: "Se incorporó al programa Pueblos Mágicos en el año 2012.
...
MagicTown.create!(name: "​Chignahuapan",
...
MagicTown.create!(name: "Tlatlauquitepec",
...
MagicTown.create!(name: "​Xicotepec",
...
MagicTown.create!(name: "​Jalpan de Serra",
...
MagicTown.create!(name: "​Cadereyta",
...
MagicTown.create!(name: "​​Tequisquiapan",
...
MagicTown.create!(name: "​​San Joaquín​​​​​​",
...
MagicTown.create!(name: "​Real de Catorce",
...
MagicTown.create!(name: "Cosalá",
                        ...
                        location: "Ubicado en la Sierra Madre Oriental Limita al norte con el municipio de Culiacán y el estado de Durango, al sur con los municipios de San Ignacio y Elota, al oriente con el estado de Durango y el municipio de San Ignacio y al poniente con los municipios de Culiacán y Elota​​",
                        state_id: 24)

MagicTown.create!(name: "El Fuerte",
...
MagicTown.create!(name: "El Rosarito",
...
MagicTown.create!(name: "Mocorito",
...
MagicTown.create!(name: "Álamos",
                        ...
                        festivities: "Festival Internacional Doctor Alfonso Ortiz Tirado: se realiza en enero con eventos culturales.​Fiestas de la Purísima Concepción: que se llevan a cabo el 8 de diciembre con feria, bailes y juegos pirotécnicos",
...
MagicTown.create!(name: "Magdalena de Kino",
...
MagicTown.create!(name: "Tapijulapa",
...
MagicTown.create!(name: "Huamantla",
...
MagicTown.create!(name: "Xico",
                        ...
                        location: "​​Se encuentra ubicado en la zona centro del Estado Limita al norte con Coatepec, al sur con Ayahualulco y Perote al Oeste. Distancia aproximada de la cabecera municipal al sur de la capital del Estado, por carretera es de 15 Km",
                        state_id:29)

MagicTown.create!(name: "Coatepec",
...
MagicTown.create!(name: "​​Papantla",
...
MagicTown.create!(name: "Coscomatepec",
...
MagicTown.create!(name: "Zozocolco",
...
MagicTown.create!(name: "Izamal",
                        ...
                        location: "El municipio  de Izamal se localiza en la región centro norte del estado.Colinda con los siguientes municipios: al norte con Tekal de Venegas,Tepakán y Tekantó, al sur con Xocchel, Kantunil y Sudzal, al este con Tunkásy al oeste con Honctún",
                        state_id: 30)

MagicTown.create!(name: "Valladolid",
...
MagicTown.create!(name: "Jerez de García Salinas",
...
MagicTown.create!(name: "​Teul González Ortega",
                        ...
                        festivities: "3 de mayo: Día de la Santa Cruz. 24 de junio: Aniversario del santo patrono del pueblo. 12 de diciembre: Dedicada a la Virgen de Guadalupe​",
                        location: "Se localiza a 114 km al norte de la ciudad de Guadalajara​​​",
                        state_id: 31)

MagicTown.create!(name: "Sombrerete",
                        ...
                        location: "Sombrerete se localiza a 170 km al norte de la capital de Zacatecas",
                        state_id: 31)

MagicTown.create!(name: "Pinos",
...
MagicTown.create!(name: "Nochistlán",
